...
<div className="px-8 items-center justify-center flex max-w-2xl m-auto my-6 max-md:text-center">
...
<h2 className="font-bold text-2xl m-auto px-4 w-full text-center my-6"> Services </h2>
